                ...
                <div class="aui-address-box aui-footer-flex">
                    <div class="aui-address-box-item aui-address-box-item-line-one">
                        <span class="aui-address-box-item-img">
                            <img src="../../../public/image/icon-ad-001.png" alt="">
                        </span>
                        <span>全球直采</span>
                    </div>
                    <div class="aui-address-box-item aui-address-box-item-line-one">
                        <span class="aui-address-box-item-img">
                            <img src="../../../public/image/icon-ad-002.png" alt="">
                        </span>
                        <span>鬼冢虎旗舰店</span>
                    </div>
                    <div class="aui-address-box-item">
                        <span class="aui-address-box-item-img">
                            <img src="../../../public/image/icon-ad-003.png" alt="">
                        </span>
                        <span>北京市</span>
                    </div>
                </div>
                        ...
                        <div class="aui-slide-list">
                            <ul class="aui-slide-item-list">
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-005.png" alt="">
                                            <span>9色可选</span>
                                        </div>
                                ...
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-006.png" alt="">
                                            <span>五折起</span>
                                        </div>
                                        <div class="aui-page-bd">
                                            <p>还好赶上活动买的 价格挺合适的 不过和原来的一双穿上感觉不一样 可能是新鞋的缘故吧</p>
                                ...
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-007.png" alt="">
                                            <span>限时</span>
                                        </div>
                                        <div class="aui-page-bd">
                                            <p>还好赶上活动买的 价格挺合适的 不过和原来的一双穿上感觉不一样 可能是新鞋的缘故吧</p>
                                ...
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-008.png" alt="">
                                            <span>3色可选</span>
                                        </div>
                                        <div class="aui-page-bd">
                                            <p>还好赶上活动买的 价格挺合适的 不过和原来的一双穿上感觉不一样 可能是新鞋的缘故吧</p>
                        ...
                        <div class="aui-slide-list">
                            <ul class="aui-slide-item-list">
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-001.png" alt="">
                                            <span>9色可选</span>
                                        </div>
                                        <div class="aui-page-bd">
                                            <p>还好赶上活动买的 价格挺合适的 不过和原来的一双穿上感觉不一样 可能是新鞋的缘故吧</p>
                                ...
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-002.png" alt="">
                                            <span>五折起</span>
                                        </div>
                                        <div class="aui-page-bd">
                                            <p>还好赶上活动买的 价格挺合适的 不过和原来的一双穿上感觉不一样 可能是新鞋的缘故吧</p>
                                ...
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-003.png" alt="">
                                            <span>限时</span>
                                        </div>
                                        <div class="aui-page-bd">
                                            <p>还好赶上活动买的 价格挺合适的 不过和原来的一双穿上感觉不一样 可能是新鞋的缘故吧</p>
                                ...
                                <li class="aui-slide-item-item">
                                    <a href="javascript:;" class="aui-link clearfix">
                                        <div class="aui-page-hd">
                                            <img src="../../../public/image/icon-page-004.png" alt="">
                                            <span>3色可选</span>
                                        </div>
                                        <div class="aui-page-bd">
                                            <p>还好赶上活动买的 价格挺合适的 不过和原来的一双穿上感觉不一样 可能是新鞋的缘故吧</p>
                    ...
                    <div class="tab-item">
                        <div class="aui-page-img">
                            <div class="aui-page-pig">
                                <img src="../../../public/image/page-001.png" alt="">
                            </div>
                            <img src="../../../public/image/page-002.png" alt="">
                            <img src="../../../public/image/page-003.png" alt="">
                            <img src="../../../public/image/page-004.png" alt="">
                            <img src="../../../public/image/page-005.png" alt="">
                            <img src="../../../public/image/page-006.png" alt="">
                            <img src="../../../public/image/page-007.png" alt="">
                            <img src="../../../public/image/page-008.png" alt="">
                            <img src="../../../public/image/page-009.png" alt="">
                        </div>
